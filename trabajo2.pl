...
tamanio_cabeza(X):-ask(tamanio_cabeza,X).
...
color(X):-ask(color,X).
tamanio_aleta_dorsal(X):-ask(tamanio_aleta_dorsal,X).
...
especie(ballena_azul) :- forma_cabeza(u),color(azul),tamanio_aleta_dorsal(pequenia),forma_aleta(triangular).
especie(ballena_fin) :- forma_cabeza(v),color(gris),tamanio_aleta_dorsal(pequenia),forma_aleta(hoz),zona_ventral(blanco).
especie(cachalote_gris) :- color(gris),tamanio_cabeza(grande),forma_aleta(triangular),piel_arrugada(si).
especie(delfin_austral) :- color(gris),parche_gris(gris).
especie(ballena_jorobada_gris) :- color(gris),tamanio_aleta_dorsal(pequenia),forma_aleta(triangular).
...
especie(ballena_jorobada_negra) :- color(negro),tamanio_aleta_dorsal(pequenia),forma_aleta(triangular).
especie(orca) :- color(negro),forma_cabeza(redonda),marca_detras_del_ojo(ojo), manchas(blanco).
especie(cachalote_cafe) :- color(cafe),tamanio_cabeza(grande),forma_aleta(triangular),piel_arrugada(si).
especie(delfin_cruzado) :- forma_cabeza(redonda),tamanio_aleta_dorsal(grande),manchas(blancas),forma_hocico(corto).
especie(lobo_marino_comun) :- tamanio_cabeza(grande),manchas(amarillentas).
